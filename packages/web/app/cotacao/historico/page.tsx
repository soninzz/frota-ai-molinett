          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="border-b border-zinc-100 text-left">
                ...
                <th className="px-5 py-3 font-medium text-zinc-500 text-[11px] uppercase tracking-wide">Cliente</th>
                <th className="px-5 py-3 font-medium text-zinc-500 text-[11px] uppercase tracking-wide">Rota</th>
            ...
            <tbody>
              ...
              {cotacoes.map((c) => (
                ...
                >
                  ...
                  <td className="px-5 py-3.5 font-mono tabular-nums text-zinc-600">{c.veiculo.placa}</td>
                  <td className="px-5 py-3.5 font-mono tabular-nums text-zinc-600">{c.margemPct}%</td>
