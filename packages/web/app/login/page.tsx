...
export default function LoginPage() {
  ...
  return (
    ...
    >
      <div className="hidden lg:flex lg:w-[46%] bg-grid bg-[#FAF8F5] relative overflow-hidden flex-col justify-between p-12">
        <div className="absolute -left-16 -top-16 h-72 w-72 rounded-full bg-[#E63A1F]/15 blur-3xl" />
        <div className="absolute right-0 bottom-0 h-96 w-96 rounded-full bg-[#C0392B]/8 blur-3xl" />
        ...
        <div className="relative">
          ...
          <p className="text-[22px] leading-snug font-semibold text-zinc-900 tracking-tight max-w-sm mb-4">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-grid-dark bg-zinc-900">
        <div className="w-full max-w-[380px]">
          <div className="lg:hidden inline-flex items-center bg-white rounded-lg px-3 py-2 mb-8">
            <Image src="/logo-molinett.png" alt="Auto Socorro Molinett" width={150} height={38} className="h-9 w-auto object-contain" priority />
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            {erro && (
              <div className="rounded-lg bg-[#C0392B]/15 border border-[#C0392B]/30 text-[#F87171] text-[12px] px-3.5 py-2.5">
                {erro}
              </div>
            )}
            <label className="block">
              <span className="block text-[12px] font-medium text-zinc-400 mb-1.5">E-mail</span>
              <input
                type="email"
                className={inputCls}
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-[11px] text-zinc-500 font-medium">OU</span>
            <div className="h-px flex-1 bg-zinc-700" />
          </div>

          <button className="w-full rounded-xl border border-zinc-700 bg-zinc-800 text-[14px] font-medium text-zinc-200 py-3 hover:bg-zinc-700 transition-colors flex items-center justify-center gap-2">
            <span className="text-[15px]">◈</span>
            Entrar com WhatsApp
          </button>

          <p className="text-[12px] text-zinc-500 text-center mt-8">
